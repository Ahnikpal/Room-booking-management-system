...
@section('dashContent')
    <div class="container">
        ...
        <table class="table table-light table-striped table-hover">
            ...
            <tbody>
                @php $i = 1; @endphp
                @foreach($data as $booking) <!-- Iterate through the data passed to the view -->
                    <tr>
                        <th scope="row">{{$i}}</th>
                        <td>{{ @$booking->user_name }}</td> <!-- Assuming user_name is part of the booking object -->
                        <td>{{ @$booking->name }}</td>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    ...
                                    <a href="{{ route('booking.view.delete', ['id' => $booking->id]) }}">
