        ...
        <div class="card" style="width:25rem">
            ...
            <div class="card-body">
                ...
                <form action="{{route('signup.create')}}" method="POST">
                    ...
                    <div class="mb-3">
                        {{-- 🔁 Just change the name to "password_confirmation" --}}
                        <label for="password_confirmation" class="form-label">Confirm Password</label>
                        <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" placeholder="Renter Password">
                    </div>
                    <div class="mb-3">
